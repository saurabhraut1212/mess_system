...
export default function CustomerDashboardPage() {
  ...
  const fetchCustomerData = async () => {
    try {
      ...
      if (!res.ok) {
        toast.error(json.error || "Failed to load customer dashboard");
      } else {
        setData(json as CustomerDashboardData);
      }
    } catch (err) {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-5 rounded-xl shadow border border-gray-100">
          <h3 className="text-gray-500 text-sm">Favorite Meal</h3>
      ...
      <div className="bg-white p-6 rounded-xl shadow border border-gray-100">
        <div className="flex flex-col sm:flex-row items-center justify-between mb-4">
          <h2 className="text-xl font-semibold text-gray-800">🛍️ Recent Orders</h2>
